  ...
  <Layout :sidebar="false">
    <div class="content">
      ...
      <nav>
        ...
        <Shortcut link="/information" text="Introduction" icon="play-icon" />
        <Shortcut link="/info" text="Topics Info" icon="sliders-icon" />
        <Shortcut link="/topics" text="Topics" icon="eye-icon" />
      </nav>
